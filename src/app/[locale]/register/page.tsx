  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-accent-500/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-accent-500/5 rounded-full blur-[100px]" />
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={lang === 'ar' ? 'اسمك الكامل' : 'John Doe'}
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded border-border bg-surface accent-accent-500"
                  required
                />
                <span className="text-sm text-text-muted">{t('auth.agreeTerms')}</span>
              </label>
