...
const actionLabels: Record<string, { en: string; ar: string }> = {
  ...
  PUBLISH_STRATEGY: { en: 'Publish Strategy', ar: 'نشر استراتيجية' },
  UNPUBLISH_STRATEGY: { en: 'Unpublish Strategy', ar: 'إلغاء نشر استراتيجية' },
  ...
  CHANGE_SUBSCRIPTION: { en: 'Change Subscription', ar: 'تغيير الاشتراك' },
