      ...
      <div className="container-custom" ref={ref}>
        ...
        <div className="max-w-md mx-auto">
          <motion.a
            ...
            className="glass rounded-2xl p-8 glow-card group text-center block hover:scale-[1.02] transition-transform"
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 flex items-center justify-center text-green-400 mx-auto mb-5 group-hover:scale-110 transition-transform">
              <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-white mb-2">WhatsApp</h3>
            <p className="text-text-muted text-base">+20 101 980 8766</p>
            <div className="mt-4 inline-flex items-center gap-2 text-sm text-green-400 font-medium">
