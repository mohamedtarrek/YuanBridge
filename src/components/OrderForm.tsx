...
import { currencyOptions, getPaymentMethods } from "@/lib/i18n/translations";
          ...
          {steps.map((s, i) => (
            <div key={s.num} className="flex items-center">
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all text-sm md:text-base ${
                  s.num === step
              ...
              <div className="glass rounded-3xl p-8 md:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.customer.name")} *</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.customer.mobile")} *</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.customer.whatsapp")}</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.customer.telegram")}</label>
                    <input
                      className="input-field"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.customer.email")} *</label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.customer.country")} *</label>
                    <input
                      className={inputClass("customer.country")}
            ...
            {step === 4 && (
              <div className="glass rounded-3xl p-8 md:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">{t("form.payment.budget")}</label>
                    <input
                      className="input-field"
                ...
                <div className="md:col-span-2 mt-5">
                  <label className="block text-sm font-medium text-text-muted mb-2">{t("form.additional.requests")}</label>
                  <textarea
                    className="input-field"
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div><span className="text-text-muted">{t("form.customer.country")}:</span> <span className="text-white">{form.customer.country}</span></div>
                      <div><span className="text-text-muted">{t("form.customer.city")}:</span> <span className="text-white">{form.customer.city}</span></div>
                      <div className="col-span-2"><span className="text-text-muted">{t("form.customer.address")}:</span> <span className="text-white">{form.customer.shippingAddress}</span></div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="col-span-2"><span className="text-text-muted">{t("form.product.url")}:</span> <span className="text-white break-all">{form.product.url}</span></div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      {form.shipping.notes && <div className="col-span-2"><span className="text-text-muted">{t("form.shipping.notes")}:</span> <span className="text-white">{form.shipping.notes}</span></div>}
                    </div>
                  </div>
